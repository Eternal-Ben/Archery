...
namespace Archery.Areas.BackOffice.Controllers
{
    public class TournamentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,StartDate,EndDate,ArcherCount,Price")] Tournament tournament)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,StartDate,EndDate,ArcherCount,Price")] Tournament tournament)
        {
            if (ModelState.IsValid)
            {
